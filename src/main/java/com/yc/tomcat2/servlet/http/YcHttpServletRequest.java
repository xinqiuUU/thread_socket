...
public class YcHttpServletRequest implements YcServletRequest {
    ...
    // 请求方式 GET post  put delete options  head trace options
    ...
    private void parseRequestInfoString(String requestInfoString) {
        ...
        this.requestURI = st.nextToken();//"/index.html?age=12&name=zhangsan"
        ...
        //网站的请求地址要为  http://localhost:8090/wowotuan/index.html
        //项目的真实路径为  /usr/local/tomcat/webapps/wowotuan
        this.realPath = System.getProperty("user.dir")+ File.separator+"webapps";//项目的真实路径
